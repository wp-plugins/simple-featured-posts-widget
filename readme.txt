...
Simple Featured Posts is a pratical widget that allows you to show a post list with thumbnails ordered by random or recent posts.
...
1. Upload the plugin folder to the /wp-content/plugins/ directory or installed it through the backend.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Go to widget section and drag it into a widget area of your template.
